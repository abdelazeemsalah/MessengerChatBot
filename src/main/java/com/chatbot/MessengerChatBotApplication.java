...
public class MessengerChatBotApplication {
	private static final Logger logger = LoggerFactory.getLogger(MessengerChatBotApplication.class);

	public static void main(String[] args) {
		SpringApplication.run(MessengerChatBotApplication.class, args);
	}
